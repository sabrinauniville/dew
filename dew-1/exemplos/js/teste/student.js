import { auth, getUserDocRef, initModules, initSettings } from './firebase-service.js';
import { elements, renderStudentDashboard, renderModuleDetail } from './ui.js';
import { gradeAnswer, calculateAverage } from './utils.js';
import { moduleDefinitions, defaultSettings } from './data.js';
